<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  while ($row = $res->fetch_object()) {
    ...
    if ($row->profile_pic == '') {
      $profile_picture = "<img src='../admin/dist/img/d1.png' class=' elevation-2' alt='User Image'>
                ";
    } else {
      $profile_picture = "<img src='../admin/dist/img/' class='elevation-2' alt='User Image'>
                ";
    }
  ...
  ?>
      ...
      <a href="pages_dashboard.php" class="brand-link">
        <img src="../admin/dist/img/<?php echo $sys->sys_logo;?>" alt="Banking Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
